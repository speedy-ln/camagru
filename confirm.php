...
<div class="container-fluid">
    ...
    <div class="row">
        <form class="form-signin" onsubmit="return false;">
            <h2 class="form-signin-heading">Confirm Email</h2>
            <label for="confirm_email" class="sr-only">Confirm Email address</label>
            <input type="text" id="confirm_email" <?php if (isset($_GET['c'])) {?> value="<?=$_GET['c'];?>" <?php } ?> class="form-control" placeholder="Activation Code" required autofocus>
            <button onclick="confirm_e();" id="confirm_btn" class="btn btn-lg btn-primary btn-block" >Activate</button>
